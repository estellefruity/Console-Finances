...
console.log(totalMonths); //Log total months result to console

//displaying result in html
function myfunction(){
    document.getElementById("totalNumMonths").innerHTML = "totalmonths";
}

//calculating total amount of profit/loss
let total = 0;
...
let result1= greatestIncreaseMonth.concat(' ', '$'+ greatestIncrease)
console.log(result1);
let result2= greatestDecreaseMonth.concat(' ', '$'+ greatestDecrease)
console.log(result2);
